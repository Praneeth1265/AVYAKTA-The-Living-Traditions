...
const domains = [
  { name: 'Technology', desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' },
  { name: 'Design', desc: 'Sed do eiusmod tempor incididunt ut labore et dolore magna.' },
  { name: 'Event Management', desc: 'Ut enim ad minim veniam, quis nostrud exercitation ullamco.' },
  { name: 'Performing Arts', desc: 'Duis aute irure dolor in reprehenderit in voluptate velit.' },
  { name: 'Media & Outreach', desc: 'Excepteur sint occaecat cupidatat non proident, sunt in culpa.' },
];
...
const AboutAvyakta = () => {
  return (
    <div className="bg-muted-white text-charcoal-black min-h-screen pt-20">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-charcoal-black font-inter leading-relaxed">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam in odio pellentesque, facilisis mi in, accumsan tortor. Aliquam nec efficitur nulla, et scelerisque nisl. Nunc sit amet enim vel risus dictum eleifend id a arcu. Fusce aliquet cursus varius.
              </p>
            </div>
          </motion.div>
      ...
      <section className="bg-charcoal-black text-muted-white py-16 relative">
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-cormorant font-bold text-bronze-gold mb-4">Our Domains</h2>
            <p className="text-dull-olive max-w-2xl mx-auto">Explore the diverse wings of Avyakta where cultural roots meet modern expression.</p>
          </div>
            ...
            {domains.map((domain, index) => (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-xl font-cormorant font-bold text-muted-white group-hover:text-gold-light transition-colors">{domain.name}</h3>
                </div>
      ...
      <section className="max-w-[1280px] mx-auto px-6 py-12">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-cormorant font-bold text-emerald-green mb-4">Why Join Us?</h2>
        </div>
        
        <div className="grid md:grid-cols-3 gap-8 text-center">
          {[
            { title: 'Grow', text: 'Curabitur blandit tempus porttitor. Nullam quis risus eget urna mollis ornare vel eu leo.' },
            { title: 'Create', text: ' Aenean lacinia bibendum nulla sed consectetur. Fusce dapibus, tellus ac cursus commodo.' },
            { title: 'Belong', text: 'Donec id elit non mi porta gravida at eget metus. Cum sociis natoque penatibus et magnis.' }
          ].map((item, i) => (
            <motion.div 
              key={item.title}
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <h3 className="text-2xl font-cormorant font-bold text-charcoal-black mb-3">{item.title}</h3>
      ...
      <section className="bg-charcoal-black relative py-16">
        <PaisleyBackground opacity="0.05" className="absolute inset-0 z-0 h-full w-full" />
        <div className="relative z-10 max-w-[1280px] mx-auto px-6 flex flex-col items-center text-center">
          ...
          >
            <h2 className="text-3xl font-cormorant text-gold-light mb-4">Ready to step into the tradition?</h2>
            <p className="text-muted-white max-w-xl mx-auto mb-8 font-inter">
              Join the cultural phenomenon. Apply now to become a part of Avyakta's next generation.
            </p>
            <NavLink 
              to="/recruitment"
          ...
          <div className="mt-8">
            <NavLink to="/members" className="text-dull-olive hover:text-gold-light transition-colors text-sm underline underline-offset-4">
