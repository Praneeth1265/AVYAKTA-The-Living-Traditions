  ...
  return (
    <section className="pt-24 pb-32 bg-muted-white text-charcoal-black relative">
      <div className="max-w-[1280px] mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-cormorant text-emerald-green font-bold mb-6">
            Experience the Tradition
          </h2>
          <p className="font-inter leading-relaxed text-lg text-charcoal-black/80 mb-8 max-w-lg">
            Avyakta brings together students passionate about performing arts,
            design, technology, and event management. It is a space where
            culture meets modern expression, allowing creativity to take the
            center stage.
          </p>
          <Link
            href="/about"
        ...
        >
          ...
          <div className="w-72 h-72 rounded-full overflow-hidden border-4 border-muted-white shadow-2xl relative bg-charcoal-black flex flex-col justify-center items-center text-center p-8 z-10">
            ...
            <div className="relative z-10">
              <span className="text-5xl font-cormorant text-gold-light mb-1 block">
                5+
              </span>
              <span className="text-sm font-inter text-muted-white tracking-widest uppercase mb-6 block">
                Domains
              </span>
              ...
              <span className="text-sm font-inter text-muted-white tracking-widest uppercase block">
                Members
              </span>
            </div>
          </div>
