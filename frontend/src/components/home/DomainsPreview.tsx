    ...
    <section className="py-24 bg-charcoal-black relative">
      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-cormorant font-bold text-bronze-gold mb-4">
            Our Domains
          </h2>
          <p className="text-dull-olive uppercase tracking-widest text-sm">
            Engage in creative and technical excellence.
          </p>
        </div>
          ...
          {domains.map((domain, i) => (
            <Link href="/recruitment" key={domain}>
              ...
              >
                ...
                <h3 className="font-cormorant text-2xl font-bold text-muted-white text-center">
                  {domain}
                </h3>
              </motion.div>
            </Link>
