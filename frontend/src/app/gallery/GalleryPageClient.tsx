...
export default function GalleryPageClient({
  ...
  const selectedImage =
    lightboxIndex !== null ? activeEvent.images[lightboxIndex] : null;
      ...
      <section className="relative overflow-hidden border-b border-[#C9A84C]/40 bg-[#1C1C1C] px-6 py-14 text-[#F5F0E8] md:px-12">
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-7 text-[#F5F0E8]/84 md:text-base">
            Browse each event timeline through curated visual moments. Select an
            event on the left and explore the masonry wall on the right.
          </p>
        </div>
      </section>
