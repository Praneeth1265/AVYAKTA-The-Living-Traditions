  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-blue-50 via-blue-100 to-purple-100 font-sans overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -bottom-12 -left-12 w-80 h-80 bg-white rounded-full opacity-20 mix-blend-overlay blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-32 right-20 w-72 h-72 bg-white rounded-full opacity-20 mix-blend-overlay blur-3xl animate-pulse"
